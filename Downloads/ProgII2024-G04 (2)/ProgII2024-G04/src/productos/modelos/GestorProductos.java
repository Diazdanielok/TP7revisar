...
public class GestorProductos implements IGestorProductos {
   ...
   private List<Producto> productos = new ArrayList<>();
    ...
    public List<Producto> menu() {
        // Ordena los productos por su implementación de Comparable (probablemente por código o descripción)
    ...
    public List<Producto> buscarProductos(String descripcion) {
        // Busca productos cuyo nombre contenga la descripción dada
        ...
        if (descripcion != null && !descripcion.isEmpty()) {
            for (Producto producto : productos) {
                if (producto.verDescripcion().toLowerCase().contains(descripcion.toLowerCase())) {
                    coincidencias.add(producto); // Añade los productos que coinciden
                }
            }
        }
    ...
    public List<Producto> verProductosPorCategoria(Categoria categoria) {
        ...
        for (Producto producto : productos) {
            if (producto.verCategoria().equals(categoria)) {
    ...
    public String borrarProducto(Producto producto) {
        ...
        for (Pedido pedido : gestorPedidos.verPedidos()) {
            for (ProductoDelPedido productoPedido : pedido.verListaDeProductos()) {
